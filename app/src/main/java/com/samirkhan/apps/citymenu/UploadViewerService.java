 ...
 */
public class UploadViewerService extends AsyncTask {
    Context mContext;
    String mUserMessage;

    public UploadViewerService(Context context) {
        this.mContext = context;
    }

    @Override
    protected Object doInBackground(Object[] params) {
        String urlString = UrlString.RootUrl()+"upload_viewer.php";
        ...
        try {
            ...
            parameters.put("data", new Viewer(mContext).uploadViewer());
